...
$($deepfry)
convert $MAIM_LOCATION_2 -liquid-rescale 50% -fill orange -tint 100 - | convert - -liquid-rescale 200% - | convert - -modulate 300,400,300  - | xclip -selection clipboard -t image/png
